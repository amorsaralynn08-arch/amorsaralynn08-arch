...
I'm a software developer passionate about building practical software that combines clean architecture, intuitive user experiences, and real-world problem solving.
...
`Python` • `React` • `ESP32` • `Arduino` • `Industrial IoT`
